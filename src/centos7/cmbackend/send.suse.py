...
def recovery():
    ...
    sql41 = "replace into main_crecovery_old values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    ...
    try:
        ...
        for i in recovery:  # print i
            ...
            if h6 in i and len(h6) + 1 == len(i):
                ...
                if (h7=="PROBLEM" and event_time <= return_time) or (h7=="ok" and event_time >= return_time) :
        ...
        if h7 == "OK":
            ...
            cur.execute(sql41, sql4_data)  # 将problem存入old表
